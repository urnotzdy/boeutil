...
import com.example.myutil.disruptor.*;
...
/**
 * 无锁高并发框架
 * 参考链接：https://mp.weixin.qq.com/s/kzDnlHQjXgkwOHP2AGjGOA
 */
public class DisruptorService {
    ...
    public static void main(String[] args) {
        ...
        // 5.连接消费端方法
        disruptor.handleEventsWith(new FirstEventHandler()).then(new NextEventHandler());
        // 6.启动
        disruptor.start();
        // 7.创建RingBuffer容器
